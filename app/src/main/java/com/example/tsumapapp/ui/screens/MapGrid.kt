...
class GridOverlay : Overlay() {  //наследуем GridOverlay от оверлея osmd
    ...
    private val cellSizeLng =
        cellSizeDegrees / Math.cos(Math.toRadians(56.47))//для квадратиков делим на коофицент широты(примерно)
    ...
    override fun draw(canvas: Canvas, mapView: MapView, shadow: Boolean) {
        ...
        val startLat =
            Math.floor(south / cellSizeDegrees) * cellSizeDegrees//шобы не "плыли" при движении карты и начанались ВСЕГДА с 1 точек
